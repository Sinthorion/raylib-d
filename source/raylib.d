...
// RenderTexture, for texture rendering
...
struct Font
{
    ...
    GlyphInfo* chars; // Glyphs info data
}
...
enum MaterialMapIndex
{
    ...
    MATERIAL_MAP_CUBEMAP = 8, // Cubemap material (NOTE: Uses GL_TEXTURE_CUBE_MAP)
    MATERIAL_MAP_IRRADIANCE = 9, // Irradiance material (NOTE: Uses GL_TEXTURE_CUBE_MAP)
...
AudioStream InitAudioStream(uint sampleRate, uint sampleSize, uint channels); // Load audio stream (to stream raw audio pcm data)
